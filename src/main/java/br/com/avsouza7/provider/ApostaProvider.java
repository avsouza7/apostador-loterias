...
public class ApostaProvider {
	...
	private Agrupador papoDeCunhadoMegaSena() {
		...
		agrupador.addApostas(2896l, DateUtil.convertBr("31/07/2025"), List.of(umaApostaMegaSena(1, 3, 4, 10, 11, 24), umaApostaMegaSena(2, 6, 9, 11, 17, 29), umaApostaMegaSena(8, 19, 21, 42, 49, 50)));
		agrupador.addApostas(2897l, DateUtil.convertBr("33/07/2025"), List.of(umaApostaMegaSena(1, 3, 4, 10, 11, 24), umaApostaMegaSena(2, 6, 9, 11, 17, 29), umaApostaMegaSena(8, 19, 21, 42, 49, 50)));
		return agrupador;
	}
