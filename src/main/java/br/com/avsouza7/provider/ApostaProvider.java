...
public class ApostaProvider {
	...
	private Agrupador sozinhoLotoFacil() {
		...
		agrupador.addApostas(3242l, List.of(umaApostaLotofacil(DateUtil.convertBr("11/11/2024"), 1, 2, 4, 6, 7, 12, 14, 15, 16, 17, 18, 19, 21, 22, 23), umaApostaLotofacil(DateUtil.convertBr("11/11/2024"), 1, 3, 5, 7, 8, 9, 11, 13, 14, 15, 17, 18, 19, 23, 24)));
		agrupador.addApostas(3243l, List.of(umaApostaLotofacil(DateUtil.convertBr("12/11/2024"), 1, 2, 4, 6, 7, 12, 14, 15, 16, 17, 18, 19, 21, 22, 23), umaApostaLotofacil(DateUtil.convertBr("12/11/2024"), 1, 3, 5, 7, 8, 9, 11, 13, 14, 15, 17, 18, 19, 23, 24)));
		agrupador.addApostas(3244l, List.of(umaApostaLotofacil(DateUtil.convertBr("13/11/2024"), 1, 2, 4, 6, 7, 12, 14, 15, 16, 17, 18, 19, 21, 22, 23), umaApostaLotofacil(DateUtil.convertBr("13/11/2024"), 1, 3, 5, 7, 8, 9, 11, 13, 14, 15, 17, 18, 19, 23, 24), umaApostaLotofacil(DateUtil.convertBr("13/11/2024"), 2, 3, 4, 7, 8, 9, 10, 11, 12, 14, 15, 20, 22, 23, 24), umaApostaLotofacil(DateUtil.convertBr("13/11/2024"), 2, 5, 9, 10, 11, 12, 13, 14, 15, 18, 19, 21, 22, 23, 25), umaApostaLotofacil(DateUtil.convertBr("13/11/2024"), 4, 7, 8, 9, 10, 11, 12, 16, 18, 19, 20, 21, 22, 24, 25), umaApostaLotofacil(DateUtil.convertBr("13/11/2024"), 1, 6, 7, 9, 12, 15, 16, 17, 18, 19, 20, 21, 22, 24, 25), umaApostaLotofacil(DateUtil.convertBr("13/11/2024"), 1, 2, 3, 4, 6, 7, 8, 10, 13, 15, 16, 18, 23, 24, 25), umaApostaLotofacil(DateUtil.convertBr("13/11/2024"), 1, 3, 4, 5, 7, 9, 10, 14, 15, 16, 18, 20, 22, 23, 24)));
		agrupador.addApostas(3245l, List.of(umaApostaLotofacil(DateUtil.convertBr("14/11/2024"), 1, 3, 5, 7, 8, 9, 11, 13, 14, 15, 17, 18, 19, 23, 24)));
		agrupador.addApostas(3246l, List.of(umaApostaLotofacil(DateUtil.convertBr("16/11/2024"), 1, 2, 4, 6, 7, 8, 9, 11, 14, 16, 17, 19, 20, 23, 24)));
		agrupador.addApostas(3247l, List.of(umaApostaLotofacil(DateUtil.convertBr("18/11/2024"), 1, 2, 4, 6, 7, 8, 9, 11, 14, 16, 17, 19, 20, 23, 24)));
		agrupador.addApostas(3248l, List.of(umaApostaLotofacil(DateUtil.convertBr("19/11/2024"), 1, 2, 4, 6, 7, 8, 9, 11, 14, 16, 17, 19, 20, 23, 24)));
		agrupador.addApostas(3249l, List.of(umaApostaLotofacil(DateUtil.convertBr("21/11/2024"), 1, 2, 4, 6, 7, 8, 9, 11, 14, 16, 17, 19, 20, 23, 24)));
		agrupador.addApostas(3250l, List.of(umaApostaLotofacil(DateUtil.convertBr("22/11/2024"), 1, 2, 4, 6, 7, 8, 9, 11, 14, 16, 17, 19, 20, 23, 24)));
		agrupador.addApostas(3251l, List.of(umaApostaLotofacil(DateUtil.convertBr("23/11/2024"), 1, 2, 4, 6, 7, 8, 9, 11, 14, 16, 17, 19, 20, 23, 24)));
		agrupador.addApostas(3252l, List.of(umaApostaLotofacil(DateUtil.convertBr("25/11/2024"), 1, 2, 4, 6, 7, 8, 9, 11, 14, 16, 17, 19, 20, 23, 24)));
		agrupador.addApostas(3253l, List.of(umaApostaLotofacil(DateUtil.convertBr("26/11/2024"), 1, 2, 4, 6, 7, 8, 9, 11, 14, 16, 17, 19, 20, 23, 24)));
		agrupador.addApostas(3255l, List.of(umaApostaLotofacil(DateUtil.convertBr("28/11/2024"), 1, 3, 4, 5, 8, 10, 13, 14, 15, 16, 19, 20, 21, 22, 23), umaApostaLotofacil(DateUtil.convertBr("28/11/2024"), 1, 2, 3, 5, 6, 7, 8, 17, 18, 19, 20, 21, 23, 24, 25), umaApostaLotofacil(DateUtil.convertBr("28/11/2024"), 1, 2, 4, 6, 7, 8, 11, 12, 13, 15, 18, 19, 20, 22, 25)));
		agrupador.addApostas(3256l, List.of(umaApostaLotofacil(DateUtil.convertBr("29/11/2024"), 1, 3, 4, 5, 8, 10, 13, 14, 15, 16, 19, 20, 21, 22, 23)));
		agrupador.addApostas(3257l, List.of(umaApostaLotofacil(DateUtil.convertBr("30/11/2024"), 1, 3, 4, 5, 8, 10, 13, 14, 15, 16, 19, 20, 21, 22, 23)));
		agrupador.addApostas(3258l, List.of(umaApostaLotofacil(DateUtil.convertBr("02/12/2024"), 1, 3, 4, 5, 8, 10, 13, 14, 15, 16, 19, 20, 21, 22, 23)));
		agrupador.addApostas(3261l, List.of(umaApostaLotofacil(DateUtil.convertBr("05/12/2024"), 1, 2, 4, 5, 10, 11, 12, 13, 14, 15, 20, 22, 23, 24, 25), umaApostaLotofacil(DateUtil.convertBr("05/12/2024"), 1, 2, 4, 6, 7, 8, 10, 11, 15, 16, 17, 19, 20, 21, 23), umaApostaLotofacil(DateUtil.convertBr("05/12/2024"), 2, 7, 8, 9, 10, 12, 13, 14, 15, 16, 18, 19, 20, 21, 23)));
		agrupador.addApostas(3262l, List.of(umaApostaLotofacil(DateUtil.convertBr("06/12/2024"), 1, 2, 4, 5, 10, 11, 12, 13, 14, 15, 20, 22, 23, 24, 25), umaApostaLotofacil(DateUtil.convertBr("06/12/2024"), 1, 2, 4, 6, 7, 8, 10, 11, 15, 16, 17, 19, 20, 21, 23), umaApostaLotofacil(DateUtil.convertBr("06/12/2024"), 2, 7, 8, 9, 10, 12, 13, 14, 15, 16, 18, 19, 20, 21, 23)));
		agrupador.addApostas(3263l, List.of(umaApostaLotofacil(DateUtil.convertBr("07/12/2024"), 1, 2, 4, 5, 10, 11, 12, 13, 14, 15, 20, 22, 23, 24, 25), umaApostaLotofacil(DateUtil.convertBr("07/12/2024"), 1, 2, 4, 6, 7, 8, 10, 11, 15, 16, 17, 19, 20, 21, 23), umaApostaLotofacil(DateUtil.convertBr("07/12/2024"), 2, 7, 8, 9, 10, 12, 13, 14, 15, 16, 18, 19, 20, 21, 23)));
		return agrupador;
	}
	...
	private Agrupador papoDeCunhadoMegaSena() {
		...
		agrupador.addApostas(2795l, List.of(umaApostaMegaSena(DateUtil.convertBr("08/11/2024"), 3, 9, 13, 35, 39, 46, 58), umaApostaMegaSena(DateUtil.convertBr("08/11/2024"), 5, 17, 18, 25, 35, 40, 42)));
		agrupador.addApostas(2800l, List.of(umaApostaMegaSena(DateUtil.convertBr("26/11/2024"), 10, 16, 48, 54, 56, 57), umaApostaMegaSena(DateUtil.convertBr("26/11/2024"), 2, 16, 23, 25, 47, 59), umaApostaMegaSena(DateUtil.convertBr("26/11/2024"), 18, 29, 45, 49, 55, 56), umaApostaMegaSena(DateUtil.convertBr("26/11/2024"), 2, 8, 10, 16, 40, 42), umaApostaMegaSena(DateUtil.convertBr("26/11/2024"), 13, 27, 38, 46, 52, 56), umaApostaMegaSena(DateUtil.convertBr("26/11/2024"), 5, 12, 16, 36, 37, 41), umaApostaMegaSena(DateUtil.convertBr("26/11/2024"), 8, 22, 24, 28, 56, 58), umaApostaMegaSena(DateUtil.convertBr("26/11/2024"), 4, 9, 17, 26, 44, 53), umaApostaMegaSena(DateUtil.convertBr("26/11/2024"), 21, 43, 44, 48, 57, 59), umaApostaMegaSena(DateUtil.convertBr("26/11/2024"), 2, 13, 23, 35, 52, 58), umaApostaMegaSena(DateUtil.convertBr("26/11/2024"), 6, 32, 36, 39, 47, 53), umaApostaMegaSena(DateUtil.convertBr("26/11/2024"), 14, 26, 46, 48, 51, 59)));
		agrupador.addApostas(2802l, List.of(umaApostaMegaSena(DateUtil.convertBr("30/11/2024"), 4, 34, 38, 39, 49, 59), umaApostaMegaSena(DateUtil.convertBr("30/11/2024"), 6, 22, 39, 42, 48, 54), umaApostaMegaSena(DateUtil.convertBr("30/11/2024"), 7, 16, 35, 36, 54, 58), umaApostaMegaSena(DateUtil.convertBr("30/11/2024"), 12, 34, 41, 47, 48, 57), umaApostaMegaSena(DateUtil.convertBr("30/11/2024"), 4, 10, 22, 28, 41, 49), umaApostaMegaSena(DateUtil.convertBr("30/11/2024"), 1, 16, 18, 31, 36, 50), umaApostaMegaSena(DateUtil.convertBr("30/11/2024"), 7, 37, 40, 47, 51, 59), umaApostaMegaSena(DateUtil.convertBr("30/11/2024"), 5, 14, 17, 30, 43, 59), umaApostaMegaSena(DateUtil.convertBr("30/11/2024"), 4, 10, 13, 17, 25, 43), umaApostaMegaSena(DateUtil.convertBr("30/11/2024"), 5, 17, 19, 30, 39, 52), umaApostaMegaSena(DateUtil.convertBr("30/11/2024"), 25, 27, 29, 40, 43, 52), umaApostaMegaSena(DateUtil.convertBr("30/11/2024"), 2, 5, 14, 38, 54, 59), umaApostaMegaSena(DateUtil.convertBr("30/11/2024"), 5, 11, 12, 24, 44, 50), umaApostaMegaSena(DateUtil.convertBr("30/11/2024"), 20, 22, 25, 26, 38, 49), umaApostaMegaSena(DateUtil.convertBr("30/11/2024"), 20, 22, 30, 33, 43, 59), umaApostaMegaSena(DateUtil.convertBr("30/11/2024"), 12, 17, 20, 36, 46, 47), umaApostaMegaSena(DateUtil.convertBr("30/11/2024"), 10, 24, 27, 29, 41, 49), umaApostaMegaSena(DateUtil.convertBr("30/11/2024"), 6, 11, 27, 39, 41, 47), umaApostaMegaSena(DateUtil.convertBr("30/11/2024"), 4, 28, 32, 48, 54, 56), umaApostaMegaSena(DateUtil.convertBr("30/11/2024"), 5, 8, 14, 47, 49, 51), umaApostaMegaSena(DateUtil.convertBr("30/11/2024"), 5, 9, 11, 25, 40, 54), umaApostaMegaSena(DateUtil.convertBr("30/11/2024"), 5, 8, 21, 36, 43, 50), umaApostaMegaSena(DateUtil.convertBr("30/11/2024"), 13, 24, 35, 51, 57, 58), umaApostaMegaSena(DateUtil.convertBr("30/11/2024"), 13, 24, 35, 51, 57, 58), umaApostaMegaSena(DateUtil.convertBr("30/11/2024"), 3, 15, 30, 33, 49, 54)));
		agrupador.addApostas(2803l, List.of(umaApostaMegaSena(DateUtil.convertBr("03/12/2024"), 9, 15, 19, 32, 38, 44), umaApostaMegaSena(DateUtil.convertBr("03/12/2024"), 23, 25, 33, 36, 44, 52), umaApostaMegaSena(DateUtil.convertBr("03/12/2024"), 23, 25, 26, 28, 42, 53), umaApostaMegaSena(DateUtil.convertBr("03/12/2024"), 12, 23, 26, 31, 47, 59), umaApostaMegaSena(DateUtil.convertBr("03/12/2024"), 3, 29, 35, 39, 44, 59), umaApostaMegaSena(DateUtil.convertBr("03/12/2024"), 1, 10, 21, 22, 46, 60), umaApostaMegaSena(DateUtil.convertBr("03/12/2024"), 5, 17, 19, 36, 39, 54), umaApostaMegaSena(DateUtil.convertBr("03/12/2024"), 10, 12, 17, 47, 54, 57), umaApostaMegaSena(DateUtil.convertBr("03/12/2024"), 5, 31, 42, 54, 58, 59), umaApostaMegaSena(DateUtil.convertBr("03/12/2024"), 1, 3, 29, 32, 37, 41), umaApostaMegaSena(DateUtil.convertBr("03/12/2024"), 4, 18, 37, 47, 55, 56), umaApostaMegaSena(DateUtil.convertBr("03/12/2024"), 6, 7, 16, 20, 36, 49), umaApostaMegaSena(DateUtil.convertBr("03/12/2024"), 2, 7, 10, 14, 22, 31), umaApostaMegaSena(DateUtil.convertBr("03/12/2024"), 5, 8, 21, 36, 43, 50), umaApostaMegaSena(DateUtil.convertBr("03/12/2024"), 13, 24, 35, 51, 57, 58), umaApostaMegaSena(DateUtil.convertBr("03/12/2024"), 3, 15, 30, 33, 49, 54), umaApostaMegaSena(DateUtil.convertBr("03/12/2024"), 17, 24, 31, 36, 42, 49), umaApostaMegaSena(DateUtil.convertBr("03/12/2024"), 14, 34, 37, 38, 46, 56), umaApostaMegaSena(DateUtil.convertBr("03/12/2024"), 8, 12, 23, 36, 44, 50), umaApostaMegaSena(DateUtil.convertBr("03/12/2024"), 1, 21, 25, 32, 48, 51), umaApostaMegaSena(DateUtil.convertBr("03/12/2024"), 2, 24, 25, 26, 43, 45), umaApostaMegaSena(DateUtil.convertBr("03/12/2024"), 9, 10, 25, 40, 44, 53), umaApostaMegaSena(DateUtil.convertBr("03/12/2024"), 12, 18, 21, 30, 28, 42), umaApostaMegaSena(DateUtil.convertBr("03/12/2024"), 1, 3, 13, 19, 23, 58), umaApostaMegaSena(DateUtil.convertBr("03/12/2024"), 1, 9, 11, 18, 22, 55)));
		return agrupador;
	}
	...
	private Agrupador sozinhoMegaSena() {
		...
		agrupador.addApostas(2794l, List.of(umaApostaMegaSena(DateUtil.convertBr("07/11/2024"), 9, 11, 25, 30, 41, 49, 51), umaApostaMegaSena(DateUtil.convertBr("07/11/2024"), 3, 4, 7, 16, 17, 22, 26), umaApostaMegaSena(DateUtil.convertBr("07/11/2024"), 12, 14, 19, 21, 27, 32, 45)));
		agrupador.addApostas(2801l, List.of(umaApostaMegaSena(DateUtil.convertBr("28/11/2024"), 16, 17, 23, 24, 33, 35)));
		return agrupador;
	}
	...
	private Agrupador inimigosDoFimMegaSena() {
		...
		agrupador.addApostas(2794l, List.of(umaApostaMegaSena(DateUtil.convertBr("07/10/2024"), 2, 21, 39, 47, 51, 59), umaApostaMegaSena(DateUtil.convertBr("07/10/2024"), 15, 18, 20, 22, 44, 50, 54)));
		return agrupador;
	}

	private Agrupador torus5aSerieMegaSena() {
		Agrupador agrupador = new Agrupador();
		agrupador.addApostas(2793l, List.of(umaApostaMegaSena(DateUtil.convertBr("05/11/2024"), 2, 7, 10, 16, 44, 59, 60), umaApostaMegaSena(DateUtil.convertBr("05/11/2024"), 8, 13, 16, 29, 35, 43), umaApostaMegaSena(DateUtil.convertBr("05/11/2024"), 1, 34, 38, 41, 46, 58), umaApostaMegaSena(DateUtil.convertBr("05/11/2024"), 1, 05, 23, 25, 29, 38, 39), umaApostaMegaSena(DateUtil.convertBr("05/11/2024"), 4, 15, 19, 31, 52, 58, 59, 60)));
		agrupador.addApostas(2794l, List.of(umaApostaMegaSena(DateUtil.convertBr("07/11/2024"), 1, 13, 18, 35, 40, 48), umaApostaMegaSena(DateUtil.convertBr("07/11/2024"), 4, 05, 10, 23, 28, 40), umaApostaMegaSena(DateUtil.convertBr("07/11/2024"), 4, 21, 27, 51, 53, 55, 57), umaApostaMegaSena(DateUtil.convertBr("07/11/2024"), 2, 11, 17, 19, 37, 42), umaApostaMegaSena(DateUtil.convertBr("07/11/2024"), 25, 30, 56, 57, 58, 60), umaApostaMegaSena(DateUtil.convertBr("07/11/2024"), 2, 5, 16, 47, 50, 56), umaApostaMegaSena(DateUtil.convertBr("07/11/2024"), 4, 7, 18, 34, 36, 49), umaApostaMegaSena(DateUtil.convertBr("07/11/2024"), 14, 17, 26, 33, 54, 56, 58)));
		agrupador.addApostas(2795l, List.of(umaApostaMegaSena(DateUtil.convertBr("08/11/2024"), 12, 14, 17, 18, 20, 44), umaApostaMegaSena(DateUtil.convertBr("08/11/2024"), 2, 11, 22, 29, 35, 57, 58), umaApostaMegaSena(DateUtil.convertBr("08/11/2024"), 14, 20, 24, 35, 42, 45, 54), umaApostaMegaSena(DateUtil.convertBr("08/11/2024"), 7, 11, 31, 39, 43, 45, 50)));
	...
	private Agrupador diretoriaMegaSena() {
		Agrupador agrupador = new Agrupador();
		agrupador.addApostas(2794l, List.of(umaApostaMegaSena(DateUtil.convertBr("07/11/2024"), 16, 22, 32, 44, 48, 49), umaApostaMegaSena(DateUtil.convertBr("07/11/2024"), 11, 19, 22, 23, 33, 37), umaApostaMegaSena(DateUtil.convertBr("07/11/2024"), 3, 9, 37, 43, 37, 59), umaApostaMegaSena(DateUtil.convertBr("07/11/2024"), 4, 25, 35, 52, 54, 58), umaApostaMegaSena(DateUtil.convertBr("07/11/2024"), 2, 12, 19, 27, 40, 44, 49), umaApostaMegaSena(DateUtil.convertBr("07/11/2024"), 6, 16, 22, 25, 31, 36, 45)
